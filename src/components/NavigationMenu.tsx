...
export default function NavigationMenu() {
    ...
    return (
        <nav className="hidden md:block absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <ul className="flex items-center justify-center gap-1 border border-zinc-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/90 rounded-full px-2 py-2 relative shadow-lg backdrop-blur-md min-h-0 text-base lg:text-lg">
                    ...
                    return (
                        <li key={name} className="relative z-10 flex justify-center items-center">
                            <Link
                                ...
                                className={`relative flex items-center justify-center px-4 lg:px-6 py-2 rounded-full text-base lg:text-lg font-medium text-center transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 dark:focus-visible:ring-blue-500 min-w-[80px] lg:min-w-[100px] text-ellipsis whitespace-nowrap overflow-hidden
