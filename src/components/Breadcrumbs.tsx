...
export default function Breadcrumbs() {
    ...
    return (
        <div className="flex items-center gap-2 text-base sm:text-lg lg:text-xl text-black dark:text-white my-auto">
            <Link href="/" className="hover:text-blue-500 font-semibold transition-all duration-200 hover:scale-105">
                {/* Initials on mobile */}
                <span className="block md:hidden text-lg">NT</span>
                {/* Full name on desktop */}
                <span className="hidden md:inline tracking-tight">Nikhil Thomas</span>
            </Link>
